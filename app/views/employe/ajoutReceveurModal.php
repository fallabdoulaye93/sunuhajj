<form id="validation" class="form-inline form-validator" data-type="update" role="form" name="form"
         action="<?= WEBROOT ?>employe/ajoutReceveur" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="file" id="input-file-events" name="photo"  class="dropify-fr" data-show-errors="true"
                    ...
                    <div class="form-group" style="width: 100%;padding: 10px;">
                        ...
                        <select id="idprofil" name="fk_profil" class="form-control select2" style="width: 100%">
                            <option value="">  <?php echo $this->lang["selectionletypedeprofil"]?></option>

                            <?php foreach ($profil as $oneTypep) { ?>
                                <option value="<?php echo $oneTypep->id; ?>"> <?php echo $oneTypep->profil; ?></option>
                            <?php } ?>
                        </select>

                    </div>
                    <input type="hidden" id="gie" value="<?= $idGIE ;?>" name="gie" value="30">
        ...
        fields: {
            ...
            fk_profil: {
                ...
                gie: {
                    validators: {
                        notEmpty: {
                            message: '<?= $this->lang['gieObligatoire']; ?>'
