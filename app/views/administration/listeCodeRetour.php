            ...
            <div class="container-fluid">
                ...
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"><?php echo $this->lang['liste_cr']; ?></h4> </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><?php echo $this->lang['liste_cr']; ?></li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                        ...
                        <div class="white-box">
                            ...
                            <div class="col-lg-12">
                                <h3 class="panel-title pull-right">
                                    <button type="button" class="open-modal btn btn-success"
                                            ...
                                            data-modal-view="<?= base64_encode("administration") ?>/<?= base64_encode("ajoutCodeRetourModal") ?>">
                            ...
                            <div class="col-lg-12">
                                <table class="table table-bordered table-hover table-responsive processing"
                                       data-url="<?= WEBROOT; ?>administration/listeCodeRetourPro">
                                    <thead>
                                    <tr>
