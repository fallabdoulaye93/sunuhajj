            ...
            <div class="container-fluid">
                ...
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"><?php echo $this->lang['gest_voyage']; ?></h4> </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">

                        <ol class="breadcrumb">
                            <li><a href="<?= WEBROOT.'home/menu'; ?>">  <?php echo $this->lang['accueil']; ?></a></li>
                            <li><a href="<?= WEBROOT.'trajets/voyages'; ?>">  <?php echo $this->lang['voyages']; ?></a></li>
                            <li class="active"><?php echo $this->lang['gest_voyage']; ?></li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                            ...
                            <div class="col-lg-12">
                                <h3 class="panel-title pull-right">
                                    <button type="button" class="open-modal btn btn-success"
                                            data-modal-controller="trajets/ajoutVoyagesModal"
                                            data-modal-view="<?= "trajets/ajoutVoyagesModal"; ?>">
                            ...
                            <div class="col-lg-12">
                                <table class="table table-bordered table-hover table-responsive processing"
                                    ...
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang['trajet']; ?></th>
