            ...
            <div class="container-fluid">
                ...
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"><?php echo $this->lang['gestionTrajets']; ?></h4> </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">

                        <ol class="breadcrumb">
                            <li><a href="<?= WEBROOT.'home/menu'; ?>">  <?php echo $this->lang['accueil']; ?></a></li>
                            <li><a href="<?= WEBROOT.'trajets/trajets'; ?>">  <?php echo $this->lang['trajet']; ?></a></li>
                            <li class="active"><?php echo $this->lang['gestionTrajets']; ?></li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
