            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group" style="width: 100%;padding: 10px;">
                        ...
                        <input type="email" id="email" name="email" class="form-control" onchange="verifEmail()" placeholder="<?php echo $this->lang['labemail']; ?>"
                               style="width: 100%">
                        <span id="msg2"></span>
                        <span class="help-block with-errors"> </span>
                    </div>
                  ...
                  <div class="form-group" style="width: 100%;padding: 10px;">
                        <label for="password" class="control-label"><?php echo $this->lang['labpwd']; ?></label>
                        <input type="password" id="password" name="password"  class="form-control" placeholder="<?php echo $this->lang['labpwd']; ?>"
                               style="width: 100%">
                        <span id="msg3"></span>
                        <span class="help-block with-errors"> </span>
                    </div>
                    ...
                    <div class="form-group" style="width: 100%;padding: 10px;">
                        ...
                        <select id="gie" name="gie" class="form-control" style="width: 100%">
                            <option value=""> <?php echo $this->lang['SelectionnezleGie']; ?></option>
