<form id="my-form" class="form-inline form-validator" data-type="update" role="form" name="form"
      action="<?= WEBROOT ?>admin/updateUtilisateur" method="post">
                ...
                <div class="col-sm-6">
                    <div class="form-group" style="width: 100%;padding: 10px;">
                        ...
                        <input type="text" id="prenom" name="prenom" value="<?= $utilisateur->prenom ?>"
                               class="form-control" placeholder="<?php echo $this->lang['labprenom']; ?>" style="width: 100%">
                    </div>
                    <div class="form-group" style="width: 100%;padding: 10px;">
                        ...
                        <input type="text" id="nom" name="nom" value="<?= $utilisateur->nom ?>" class="form-control"
                               placeholder="<?php echo $this->lang['labnom']; ?>" style="width: 100%">
                    </div>
                    <div class="form-group" style="width: 100%;padding: 10px;">
                        ...
                        <input type="email" id="email" name="email" value="<?= $utilisateur->email ?>"
                               class="form-control" placeholder="<?php echo $this->lang['labemail']; ?>" style="width: 100%">
                    </div>
                    <div class="form-group" style="width: 100%;padding: 10px;">
                        ...
                        <input type="text" id="login" name="login" value="<?= $utilisateur->login ?>"
                               class="form-control" placeholder="<?php echo $this->lang['labLogin']; ?>" style="width: 100%">
                        <?// print $token; ?>
