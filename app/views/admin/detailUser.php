        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title"><?= $this->lang['detailRespo']; ?></h4> </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">

                    <ol class="breadcrumb">
                        <li><a href="<?= WEBROOT.'menu/menu'; ?>"><?= $this->lang['accueil']; ?></a></li>

                        <li><a href="<?= WEBROOT.'admin/listeResGiePro'; ?>"><?= $this->lang['listeResponsable']; ?></a></li>
                    ...
                    <div class="white-box">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="home">
                                ...
                                <form class="form-horizontal form-material" method="post" action="<?= WEBROOT ?>admin/updateUtilisateurDetail" data-toggle="validator">
        ...
        <div class="modal fade" role="dialog" aria-labelledby="gridSystemModalLabel" id="deleteUser" data-keyboard="false" data-backdrop="static">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form method="post" action="<?= WEBROOT ?>admin/updateEtatUser">
                        <input type="hidden" name="id" value="<?= base64_encode($user->id); ?>"/>
