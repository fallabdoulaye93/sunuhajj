            ...
            <div class="container-fluid">
                ...
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"><?php echo $this->lang['gestion_gie']; ?></h4> </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><?php echo $this->lang['gestion_gie']; ?></li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                        ...
                        <div class="white-box">
                            ...
                            <div class="col-lg-12">
                                <h3 class="panel-title pull-right">
                                    <button type="button" class="open-modal btn btn-success"
                                            data-modal-controller="admin/admin/ajoutGieModal"
                                            data-modal-view="<?= base64_encode("admin") ?>/<?= base64_encode("ajoutGieModal") ?>">
                                        <i class="fa fa-plus"></i> <?php echo $this->lang['newGie']; ?>
                                    </button>
                                </h3>
                            </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <table class="table table-bordered table-hover table-responsive processing"
                                       data-url="<?= WEBROOT; ?>admin/listeGiePro">
                                    <thead>
                                    <tr>
                                        <th> <?php echo $this->lang['nomGie']; ?></th>
                                        <th><?php echo $this->lang['adresse']; ?></th>
<!--                                        <th>--><?php //echo $this->lang['responsable']; ?><!--</th>-->
