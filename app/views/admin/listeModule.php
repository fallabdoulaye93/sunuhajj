        ...
        <div class="container-fluid">
            ...
            <div class="row bg-title">
                ...
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="<?= WEBROOT.'administration/indexx'; ?>">  <?php echo $this->lang['administration']; ?></a></li>
                            ...
                            <div class="col-lg-12">
                                <h3 class="panel-title pull-right">
                                    ...
                                    <button type="button" class="open-modal btn btn-success"
                                            data-modal-controller="admin/administration/ajoutModuleModal"
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <table class="table table-bordered table-hover table-responsive processing"
                                       data-url="<?= WEBROOT; ?>administration/listeModulePro">
                                    <thead>
                                    <tr>
