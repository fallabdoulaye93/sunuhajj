        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title"><?= $this->lang['detailUser']; ?></h4> </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">

                    <ol class="breadcrumb">
                        <li><a href="<?= WEBROOT.'menu/menu'; ?>"><?= $this->lang['accueil']; ?></a></li>

                        <li><a href="<?= WEBROOT.'administration/listeUtilisateur'; ?>"><?= $this->lang['listeUtilisateur']; ?></a></li>

                        <li class="active"><?= $this->lang['detailUser']; ?></li>
                    </ol>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                    ...
                    <div class="white-box">
                        ...
                        <div class="user-btm-box">
                            ...
                            <div class="col-sm-7" align="center">
                                <img class="img-circle" width="200"   alt="<?= $user->photo ?>" src="<?= ASSETS."pictures/".$user->photo ?>">
                            </div>
                    ...
                    <div class="white-box">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="home">
                                ...
                                <form class="form-horizontal form-material" method="post" action="<?= WEBROOT ?>administration/updateUtilisateurDetail" data-toggle="validator">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12"><?= $this->lang['labLogin'].'(*) :' ; ?></label>
                                        <div class="col-md-12">
                                            <input type="text" required class="form-control"  id="login" name="login" value="<?= $user->login; ?>">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input width="36" type="file" id="input-file-events" name="photo" class="dropify-fr" data-show-errors="true"
                                                   data-max-file-size="1M" data-allowed-file-extensions="png jpg jpeg" data-default-file="<?= ASSETS."pictures/".$user->photo ?>" />
                                            <span id="msg1"></span>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
