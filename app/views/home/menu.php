            ...
            <div class="top-left-part" style="padding-left: 30px;">
                ...
                <a class="logo" href="<?php echo WEBROOT ?>menu/menu">
                    ...
                    <b>
                        ...
                        <img src="<?= ASSETS; ?>plugins/images/logo-sunuhajj.png"  alt="home" class="dark-logo " style="background-color: #FFFFFF"/>
                        ...
                        <div class="row row-in">
                            <div class="col-lg-3 col-sm-6 row-in-br">
                                <ul class="col-in">
                                    ...
                                    <li class="col-middle">
                                        <h4><?php echo $this->lang['nbrebus']; ?></h4>
<!--                                        <div class="progress">-->
<!--                                            <div class="progress-bar progress-bar-danger" role="progressbar"-->
<!--                                                 aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"-->
<!--                                                 style="width: 40Controleur%">-->
...
<!--                                        </div>-->
                            ...
                            <div class="col-lg-3 col-sm-6 row-in-br  b-r-none">
                                <ul class="col-in">
                                    ...
                                    <li class="col-last"><h3 class="counter text-right m-t-15"> <?php echo $nbreChauffeur+$nbreReceveur+$nbreControleur;?></h3></li>
                                    <li class="col-middle">
                                        <h4><?php echo $this->lang['nbre_personnel']; ?></h4><br/>
                                        <h4><?php echo $this->lang['chauffeur']; ?>: <?php echo $nbreChauffeur;?></h4>
                                        <h4><?php echo $this->lang['receveur']; ?>: <?php echo $nbreReceveur;?></h4>
                                        <h4><?php echo $this->lang['controleur']; ?>: <?php echo $nbreControleur;?></h4>
...
<!--                                        </div>-->
                            ...
                            <div class="col-lg-3 col-sm-6 row-in-br">
                                <ul class="col-in">
                                    ...
                                    <li class="col-last"><h3 class="counter text-right m-t-15"><?php echo $montant;?></h3></h3></li>
                                    <li class="col-middle">
                                        <h4>Transaction des bus par jour</h4>
<!--                                        <div class="progress">-->
