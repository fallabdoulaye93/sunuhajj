    ...
    <div class="container-fluid">
        ...
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title"><?php echo $this->lang['transactionprjour']; ?></h4> </div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">

                <ol class="breadcrumb">
                    <li><a href="<?= WEBROOT.'home/menu'; ?>">  <?php echo $this->lang['accueil']; ?></a></li>
                    <li><a href="<?= WEBROOT.'transaction/transactionsJournalieres'; ?>">  <?php echo $this->lang['transaction']; ?></a></li>
                    <li class="active"><?php echo $this->lang['listedestransactions']; ?></li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
            ...
            <div class="col-md-12">
                <div class="white-box">
                    ...
                    <div class="row bg-title">
                        ...
                        <form class="form-horizontal" method="POST" action="<?php echo WEBROOT ?>transaction/transactionsJournalieres">
            ...
            <div class="col-md-12">
                <div class="white-box">
                    ...
                    <div class="panel-heading" style="height: 55px; background-color: #2f5088">
                        <div class="col-md-11"><h3 class="panel-title pull-left" style="color: white;"> <?php echo $this->lang['transactionprjour'] ?> </h3>
                        </div>

                       <!-- <div class="col-md-1">

                            <form method="post" id="loadform" action="<?php /*echo WEBROOT */?>transaction/printTransactionsJournalieres" target="_blank">
                                <input type="hidden" name="datedeb" value="<?/*= $datedeb2; */?>">
                                <input type="hidden" name="datefin" value="<?/*= $datefin2; */?>">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <table class="table table-bordered table-hover table-responsive processing"
                                   data-url="<?= WEBROOT; ?>transaction/transactionsJournalieresPro__/<?php echo $liste; ?>/<?php echo $datedeb; ?>/<?php echo $datefin; ?>/<?php echo $fkcarte; ?>">
                                <thead>
                                <tr>
                                    <th> <?php echo $this->lang['date']; ?></th>
                                    <th><?php echo $this->lang['nbrebus']; ?></th>
