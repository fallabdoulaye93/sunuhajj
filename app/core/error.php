        ...
        <div class="col-xs-12 ground-color text-center">
            ...
            <?php switch($this->_message['MSG_ERROR']['type']) {
                case '400':
                    ...
                    break;
                case '401':
                    echo "<p class='h1'><p>Acces refusé !</p> <p>n'etes pas autorisé à executer cette action! .</p></p>";
                    break;
                case '402':
                ...
                case '403':
                    ...
                    break;
                case '404':
                    echo "<p class='h1'>La page ".implode('/',$this->_message['MSG_ERROR']['alert'])." est introuvable !</p>";
                    break;
                case '405':
                    echo "<p class='h1'>Méthode non autorisée.</p>";
                    break;
                case '500':
                    echo "<p class='h1'>Erreur de connexion à la base de données</p>";
                    break;
                case '501':
                ...
                case '505':
                    ...
                    break;
                default:
                    echo "<p class='h1'>".$this->_message['MSG_ERROR']['type']."</p>";
            }
            $this->_message['MSG_ERROR']['type'] = str_split($this->_message['MSG_ERROR']['type']);
            ?>
            <div>
...
<script>
    ...
    loop3 = setInterval(function()
    {
        ...
        {
            clearInterval(loop3);
            selector3.textContent = (valSel3 !== undefined) ? valSel3 : '?';
        }else
        {
    ...
    loop2 = setInterval(function()
    {
        ...
        {
            clearInterval(loop2);
            selector2.textContent = (valSel2 !== undefined) ? valSel2 : '?';
        }else
        {
    ...
    loop1 = setInterval(function()
    {
        ...
        {
            clearInterval(loop1);
            selector1.textContent = (valSel1 !== undefined) ? valSel1 : '?';
        }else
        {
